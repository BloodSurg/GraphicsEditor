...
QT_MOC_LITERAL(4, 26, 15), // "Qt::MouseButton"
QT_MOC_LITERAL(5, 42, 6) // "button"

    },
    "ColorLabel\0clicked\0\0color\0Qt::MouseButton\0"
    "button"
};
...
void ColorLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< QColor(*)>(_a[1])),(*reinterpret_cast< Qt::MouseButton(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ColorLabel::*)(QColor , Qt::MouseButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorLabel::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ColorLabel::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_ColorLabel.data,
    qt_meta_data_ColorLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ColorLabel::clicked(QColor _t1, Qt::MouseButton _t2)
{
