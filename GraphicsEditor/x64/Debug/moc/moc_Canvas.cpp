...
QT_MOC_LITERAL(1, 7, 13), // "colorSelected"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "color"
QT_MOC_LITERAL(4, 28, 15), // "Qt::MouseButton"
QT_MOC_LITERAL(5, 44, 6), // "button"
QT_MOC_LITERAL(6, 51, 12), // "toolSelected"
QT_MOC_LITERAL(7, 64, 7) // "toolSel"

    },
    "Canvas\0colorSelected\0\0color\0Qt::MouseButton\0"
    "button\0toolSelected\0toolSel"
};
...
static const uint qt_meta_data_Canvas[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QColor, 0x80000000 | 4,    3,    5,
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colorSelected((*reinterpret_cast< QColor(*)>(_a[1])),(*reinterpret_cast< Qt::MouseButton(*)>(_a[2]))); break;
        case 1: _t->toolSelected((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Canvas::*)(QColor , Qt::MouseButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::colorSelected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::toolSelected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::colorSelected(QColor _t1, Qt::MouseButton _t2)
{
...
// SIGNAL 1
void Canvas::toolSelected(bool _t1)
{
